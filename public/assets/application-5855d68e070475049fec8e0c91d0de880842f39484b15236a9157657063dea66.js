...
(function() {
  $(function() {
    var table;
    return table = $('#codes-table').dataTable({
      dom: 'C<"clear">lfrtip',
      processing: true,
      serverSide: true,
...
(function() {
  $(function() {
    var table;
    return table = $('#countries-table').dataTable({
      dom: 'C<"clear">lfrtip',
      processing: true,
      serverSide: true,
...
(function() {
  $(function() {
    var table;
    return table = $('#games-table').dataTable({
      dom: 'C<"clear">lfrtip',
      processing: true,
      serverSide: true,
...
(function() {
  $(function() {
    var table;
    return table = $('#locations-table').dataTable({
      dom: 'C<"clear">lfrtip',
      processing: true,
      serverSide: true,
...
(function() {
  $(function() {
    var table;
    return table = $('#players-table').dataTable({
      dom: 'C<"clear">lfrtip',
      processing: true,
      serverSide: true,
...
(function() {
  $(function() {
    var table;
    return table = $('#sessions-table').dataTable({
      dom: 'C<"clear">lfrtip',
      processing: true,
      serverSide: true,
...
(function() {
  $(function() {
    ...
    return $('#global-modal').on('shown.bs.modal', function() {
      $('#display-selected-table tbody').sortable();
      $('#display_template_add').on('click', function() {
        var t, v;
      ...
      $(document).on("click", "#display-selected-table tbody tr td .del-btn", function() {
        var id, key, value;
        id = void 0;
        key = void 0;
        value = void 0;
...
(function() {
  $(function() {
    var table;
    return table = $('#teams-table').dataTable({
      dom: 'C<"clear">lfrtip',
      processing: true,
      serverSide: true,
...
(function() {
  $(function() {
    var table;
    return table = $('#umpires-table').dataTable({
      dom: 'C<"clear">lfrtip',
      processing: true,
      serverSide: true,
